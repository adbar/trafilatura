...
def run_trafilatura(htmlstring):
    ...
    result = extract(
        htmlstring, no_fallback=True, include_comments=False, include_tables=True, include_formatting=False
    )  # , deduplicate=False
    return result
...
def run_trafilatura_fallback(htmlstring):
    ...
    result = extract(
        htmlstring, no_fallback=False, include_comments=False, include_tables=True, include_formatting=False
    )  # , deduplicate=False
    return result
...
def run_trafilatura_recall(htmlstring):
    ...
    result = extract(
        htmlstring, no_fallback=False, favor_recall=True, include_comments=False, include_tables=True, include_formatting=False
    )  # , deduplicate=False
    return result
