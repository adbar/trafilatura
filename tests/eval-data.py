...
'https://flowfx.de/blog/copy-paste-from-tmux-to-system-clipboard/': {
    ...
    'date': '2020-01-16',
    'description': 'For the first time in many years I am using a Linux machine for my work. In general I am extremely pleased with the system I've set up. But of course, there are things that don't &quot;just work&quot;.
Like... ',  # in HTML source
    'categories': [''],
    'tags': [''],
...
'https://gnadlib.wordpress.com/2020/01/05/scherenschnitt-3/#more-27529': {
    'file': '',  # stays empty until download
    'author': 'gnaddrig',
...
'http://www.silvias.net/blog/wahlzensur-angriff-auf-universitaeten/': {
    ...
    'without': ['alle inhalte @silviajura', 'R'www.colours-of-the-soul.alhelm.net': {
    'file': '',  # stays empty until download
    'author': '',
    'title': 'trnd-Projekt “G Data InternetSecurity 2009”',
    'date': '2009-02-18',
...
'https://2gewinnt.wordpress.com/uber-uns/': {
    'file': '',  # stays empty until download
    'author': '',egistrieren', 'http://www.celiamara.net'],  # 3 segments
    'comments': [''],  # 0 or 3 segments
    'license': '',  # if CC-...
    'region': '',  # if obvious: DE, CH, AT
},
...
'www.together-online.ch': {
    'file': '',  # stays empty until download
    'author': '',
    'title': 'Speed-Dating Frauenfeld',
    'date': '',
    'description': '',  # in HTML source
    'categories': [''],
    'tags': [''],
    'with': ['Die Speed-Datings Frauenfeld', 'Interessiert? Dann melden', 'Coworking, direkt beim'],  # 3 segments
    'without': ['Abonniere unseren Newsletter', 'Über Uns', 'together ag - Partner '],  # 3 segments
    'comments': [''],  # 0 or 3 segments
    'license': '',  # if CC-...
    'region': 'DE',  # if obvious: DE, CH, AT
},
...
'https://prof-pc.de/': {
    ...
    'without': [' Datenschutzerklärung · Impressum'],  # 3 segments
    'comments': [''],  # 0 or 3 segments
    'license': '',  # if CC-...
    'region': 'DE',  # if obvious: DE, CH, AT
},
...
'http://archiv.krimiblog.de/?p=2895': {
    ...
    'with': ['Okay, hat wieder nichts mit', 'Ergänzung 2: Glaubt man', 'Ergänzung 1: Den Text des Songs'],  # 3 segments
    'without': ['Leider sind keine Kommentare möglich.', 'Rasterfahndung', 'Dies ist das Archiv von krimiblog.de'],  # 3 segments
    'comments': ['Hamburg feiert CSD. Vielleicht'],  # 0 or 3 segments
    'license': 'CC BY-NC-ND 3.0 DE',  # if CC-...
    'region': 'DE',  # if obvious: DE, CH, AT
},
'https://journal.3960.org/posts/2019-12-22-firefox-weniger-werbung-mehr-speed-unter-android/': {
    ...
    'date': '2019-12-22',
    'description': 'Werbung nervt. Tracking nervt. Nerven nervt. Und gerade mobil habe ich eigentlich keine Zeit, meine geringe Download-Rate mit dem Herunterladen von hässlichen…',  # in HTML source
...
'https://beyssonmanagement.com/2014/07/15/was-ist-innovation/': {
    ...
    'date': '2014-07-15',
    'description': 'Am 14. Juni 2005 hielt Steve Jobs eine vielbeachtete Rede vor den Absolventen der Stanford University. Den Zuhörern erzählte er drei Geschichten, die für sein Leben wichtig waren. “The first story …',  # in HTML source
...
'https://damianduchamps.wordpress.com/2019/08/03/office-365-hbdi-die-dritte/': {
    ...
    'comments': ['Vielen Dank für alle die guten Beiträge', 'bestehenden Probleme zu bereinigen', 'dies auch thematisiert werden sollte.'],  # 0 or 3 segments
    'license': 'CC BY 3.0 DE',  # if CC-...
    'region': '',  # if obvious: DE, CH, AT
},
...
'https://www.unsere-zeitung.at/2020/02/02/ist-die-inklusion-im-kapitalismus-umsetzbar/': {
    ...
    'comments': ['Wenns nur der Kapitalismus alleine wäre …'],  # 0 or 3 segments
    'license': '',  # if CC-...
    'region': 'AT',  # if obvious: DE, CH, AT
},
...
'https://www.unterwegsinberlin.de/radtouren-berlin/radtour-durch-friedrichsfelde-karlshorst-und-schoeneweide/': {
    ...
    'date': '2020-02-02',
    'description': 'Spoiler-Alarm: Meine neue Lieblings-Radtour in Berlin. Viele Jahre war ja die Müggelsee-Runde tatsächlich meine Lieblings-Radtour, das hat sich nun aber geändert.',  # in HTML source
...
'https://wolfgangschmale.eu/abgebrochene-forschung-eine-neue-studie-von-heinz-duchhardt/': {
    ...
    'comments': ['Danke für die schöne Zusammenfassung!'],  # 0 or 3 segments
    'license': '',  # if CC-...
    'region': '',  # if obvious: DE, CH, AT
},
...
'https://www.anchor.ch/gesellschaft/ein-tag-aus-dem-leben-eines-taugenichts-oder-die-leute-von-sri-lanka/': {
    ...
    'date': '2019-12-22',
    'description': 'Es ist sechs Uhr früh und noch stockdunkel. Vom nahen Kloster dringen die monotonen Gebetsgesänge der buddhistischen Priester in meine Ohren. Für mich ist es die reinste Kakophonie. Und bestimmt ko…',  # in HTML source
    'categories': ['Gesellschaft', 'Länder', 'Menschen', 'Sri Lanka'],
    'tags': ['Alltag', 'Religionen', 'Sri Lanka', 'Tiere'],
    'with': ['Es ist sechs Uhr früh und noch stockdunkel', 'führen diese improvisierten Tüten aus Schülernotizen.', 'Kumara kennt mich recht gut'],  # 3 segments
    'without': ['Deine E-Mail-Adresse wird nicht veröffentlicht', 'Blog via E-Mail abonnieren', 'Peter Addor ist Mathematiker, Systemdenke'],  # 3 segments
    'comments': ['wunderbarer Text, Danke!', 'Danke Peter für den interessanten Bericht!', 'lieber Martin'],  # 0 or 3 segments
    'license': 'CC BY-NC 4.0',  # if CC-...
    'region': 'CH',  # if obvious: DE, CH, AT
},
...
'https://thebigbone.wordpress.com/2017/04/13/die-ueberforderung-durch-ueberangebote/': {
    ...
    'with': ['Bist du auch schon mal die Regale im Supermarkt', 'Wir sind die Opfer einer Gesellschaft', 'Die Beschleunigung im Privaten liegt'],  # 3 segments
    'without': ['Gib deine E-Mail-Adresse ein', 'Kommentare zu', 'Ähnliche Beiträge'],  # 3 segments
    'comments': ['So wahr!', 'Toller Text – spannendes Thema'],  # 0 or 3 segments
    'license': '',  # if CC-...
    'region': '',  # if obvious: DE, CH, AT
},
...
'https://www.travanto.de/urlaubsziele/ibiza/': {
    'file': '',  # stays empty until download
    'author': '',
    'title': 'Ferienwohnungen & Ferienhäuser für Ihren Urlaub auf Ibiza',
    'date': '',
    'description': '',  # in HTML source
    'categories': [''],
    'tags': [''],
    'with': ['Die bei Touristen sehr beliebte Ferieninsel', 'Die Metropole Ibiza-Stadt wird von alten Wehrmauern', 'Fincas blicken auf eine lange Geschichte zurück'],  # 3 segments
    'without': ['Keine Urlaubsangebote mehr verpassen!', 'Mit der Eintragung Ihrer E-Mail Adresse', '© OpenStreetMap contributors'],  # 3 segments
    'comments': [''],  # 0 or 3 segments
    'license': '',  # if CC-...
    'region': '',  # if obvious: DE, CH, AT
},
