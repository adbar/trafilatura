...
def test_titles():
    ...
    tests = [
        ...
        ('<html><head><title>Head Title</title></head><body><h1>First</h1><h1>Second</h1></body></html>', 'Head Title'),
        # domain-like head titles are ignored, falling back to the first h1
        ('<html><head><title>example.com</title></head><body><h1>First</h1><h1>Second</h1></body></html>', 'First'),
