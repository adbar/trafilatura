...
def test_extraction():
    ...
    # hreflang
    assert sitemaps.process_sitemap('https://test.org/sitemap', 'test.org', 'https://test.org/', '<?xml version="1.0" encoding="UTF-8"?><urlset><url><loc>http://www.test.org/english/page.html</loc></url></urlset>', target_lang='en') == ([], ['http://www.test.org/english/page.html'])
