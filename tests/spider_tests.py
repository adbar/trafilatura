...
def test_meta_redirections():
    ...
    tests = [
        ...
        # malformed
        ('<html><meta http-equiv="refresh" content="3600\n&lt;meta http-equiv=" content-type=""></html>', 'https://httpbun.com/', 'https://httpbun.com/'),

        # wrong URL
        ('<html><meta http-equiv="refresh" content="0; url=1234"/></html>', 'https://httpbun.com/', None),

        # normal
        ('<html><meta http-equiv="refresh" content="0; url=https://httpbun.com/html"/></html>', 'http://test.org/', 'https://httpbun.com/html'),
...
def test_process_links():
    ...
    assert len(todo) == 4 and 'https://example.org/en/page1/' in todo  # TODO: remove slash?
...
def test_crawl_logic():
    ...
    todo = spider.URL_STORE.find_unvisited_urls(base_url)
    known_links = spider.URL_STORE.find_known_urls(base_url)
    assert todo == [] and known_links == [url,] and base_url == 'https://httpbun.com' and i == 1 and not is_on
