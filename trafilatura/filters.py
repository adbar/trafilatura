...
# Add some filters for Chinese social medias
RE_FILTER = re.compile(r'\W*(WeChat|QQ|WeiBo|Drucken|E-?Mail|Facebook|Flipboard|Google|Instagram|Linkedin|Mail|PDF|Pinterest|Pocket|Print|Reddit|Twitter|Whatsapp|Xing|Mehr zum Thema:?|More on this.{,8}$)$', flags=re.IGNORECASE)
