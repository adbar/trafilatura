...
BODY_XPATH = ['//*[(self::div or self::section)][contains(@id, "content-main")  or contains(@class, "content-main") or contains(@class, "content_main") or @id=" article" or @id="articleContent" or @itemprop="articleBody" or @class="post" or  @class="entry" or @id="story" or @class="story" or starts-with(@id, "story")]', \
            ...
            '//*[(self::div or self::main or self::section)][@id="content" or contains(@class, "ArticleContent") or contains(@class, "page-content") or contains(@class, "text-content") or contains(@class, "content__body")]', \
            '//article', \
            ...
            "//*[(self::div or self::section)][starts-with(@class, 'wpb_text_column') or contains(@class, 'single-post')]", \
            '//div[@class="cell"]', \
            '//*[(self::div or self::section)][starts-with(@class, "content ") or contains(@class, " content") or @class="content" or class="story-content"]', \
            '//main', \
            ]
